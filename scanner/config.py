...
class ScannerConfig:
    ...
    # 30 symbols x ~300 daily bars stays below Alpaca's 10,000-row page
    # in most cases, avoiding a second pagination request per batch.
    bar_batch_size: int = 30
